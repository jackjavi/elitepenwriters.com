...
export default function ContactForm() {
  ...
  return (
    <>
      ...
      {/* Main Content */}
      <div className="bg-gray-700 text-white p-6 shadow-lg max-w-3xl md:mx-auto mt-10 mx-4 mb-8">
        ...
        <div className="mt-6">
          ...
          <ul className="mt-2 text-xs lg:text-sm xl:text-md 2xl:text-lg">
            ...
            <li className="mt-2">
              ...
              . We respond to urgent queries 365 days a year, including
              weekends.
            </li>
          </ul>
        </div>
